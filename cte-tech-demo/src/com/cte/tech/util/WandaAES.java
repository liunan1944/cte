...
//    public InputStream encryptInputStream(InputStream is) throws WandaCryptoAESException {
//        return new CipherInputStream(is, getEncryptCipher());
//    }
//    public InputStream decryptInputStream(InputStream is) throws WandaCryptoAESException {
//        return new CipherInputStream(is, getDecryptCipher());
//    }
//
//    public OutputStream encryptOutputStream(OutputStream os) throws WandaCryptoAESException {
//        return new CipherOutputStream(os, getEncryptCipher());
//    }
//
//    public OutputStream decryptOutputStream(OutputStream os) throws WandaCryptoAESException {

package com.cte.credit.custom.quartz;
...
import com.cte.credit.custom.quartz.init.BaseDataParser;
	...
	public void exec() {
		...
		try{
			...
			if(minute<5){
				...
				PropertyInitUtil.routeSet(trade_id,"gw-routeCustom",true);
				PropertyInitUtil.routeSet(trade_id,"gw-routeCustom2",true);
			}
